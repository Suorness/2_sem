...
begin
  ...
  for j:=1 to 10 do
    ...
    begin
      ...
      inaction:=0;
      massfield:=Cmassfield;
      proccese(first,second,firstlist,secondlist,massField,j,i,worktime,inaction);          writeln('Результат ',218/(worktime*i):0:3,' ',inaction:3,' ',j:2,' ',i:2,' ', ((worktime*i-inaction)-218):3);
    end;
  readln;
end.
