...
var
  Form1: TForm1;
  Film: Tfilm;
  ArrFilm:array[1..80] of Tfilm;//массив для записей
  Arrdata:array[1..80] of integer;// массив для поиска
  Col:byte;  //колличество записей
...
Stringgrid1.Cells[1,0]:='Режиссер';
Stringgrid1.Cells[2,0]:='В главной роли №1';
Stringgrid1.Cells[3,0]:='В главной роли №2';
Stringgrid1.Cells[4,0]:='Год выпуска';
Stringgrid1.Cells[5,0]:='Продолжительность';
...
//переходим к форме №2 для ввода данных.
begin
Form2.Button1.Caption:='Добавить';
Form2.Caption:='Добавление данных';
Form2.Show;
Form1.Hide;
end;
...
begin
if MessageDlg('Все несохраненные записи будут потеряны, хотите продолжить?',
...
// Добавление записей из StringGrid1 в массив.
...
procedure TForm1.N9Click(Sender: TObject);//Редактирование
var nomber: integer;
begin
//Считывание номера выделенной строки
//загрузка данных из StringGrid на Form2
...
procedure TForm1.N11Click(Sender: TObject);//Удаление строки
var
nomber,i,j : integer;
begin
nomber:=StringGrid1.Row;
if messageDlg('Удалить фильм  '+ StringGrid1.Cells[0,nomber], MtCustom,
 [mbYes, mbNo],0)=MrYes then
  begin
  //очень своеобразное удаление, главное что работает :)
...
procedure TForm1.N3Click(Sender: TObject);//сохранение в фаил
var
F:File of TFilm;
i,j:integer;
Str:TFilm;
...
begin
showmessage('Нет записей для сохраения!');
exit;
end;
...
begin  //закрытие приложения нажатием на крестик в правом верхнем углу
if MessageDlg('Все несохраненные записи будут потеряны, хотите продолжить?',
  mtCustom, [mbOk, mbCancel],0)=mrOk
  then
...
var i,j,sum,max,a: integer; // поиск самого популярного режиссера:)
begin
...
showmessage('Самый популярный режиссер'+#13+arrfilm[a].Director);
end;

procedure TForm1.N20Click(Sender: TObject);
var j:integer;
begin  //отмена результатов поиска, выводим исходный массив
...
Showmessage('Фильмов нынешнего года в базе:'+#13+inttostr(s));
end;
