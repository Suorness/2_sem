...
procedure addUnTerm(var addTermin:termin;var hashTable:TPHashTable);
var
  firstEl,firstpage:termin;
  str:string;
  Nomberterm:integer;
  page,i:integer;
begin
  writeln('Имеются ли подтермины у подтермина?');
